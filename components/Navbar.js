        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between relative">
          ...
          <div className="hidden md:flex items-center gap-8">
            ${navItems.map((item) => html`
              ...
              >
                ${item.label}
                ${location.pathname === item.path && html`
            ...
            <button 
                ...
                title="Toggle Theme"
            >
                ${isDark ? html`<${Sun} size=${20} />` : html`<${Moon} size=${20} />`}
            </button>
          ...
          <div className="flex items-center gap-4 md:hidden">
              ...
              >
                  ${isDark ? html`<${Sun} size=${24} />` : html`<${Moon} size=${24} />`}
              </button>
              <button 
              ...
              >
                ${mobileMenuOpen ? html`<${X} size=${28} />` : html`<${Menu} size=${28} />`}
              </button>
          </div>
        </div>
      </nav>
